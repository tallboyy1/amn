    ...
    return (
        <main className="pt-14 mx-4">
            ...
            <section className="mt-16 mb-20 grid md:flex justify-around md:flex-wrap gap-1">
                ...
                <div className="mb-10 lg:mb-0 text-left w-44">
                    <h1 className="text-2xl h-16 mb-2 lg:mb-6 text-wrap font-heading leading-6">Inclusivity & Empowerment</h1>
                ...
                <div className="mb-10 lg:mb-0 text-left w-44">
                    <h1 className="text-2xl h-16 mb-2 lg:mb-6 text-wrap font-heading leading-6">Sustainability</h1>
                ...
                <div className="mb-10 lg:mb-0 text-left w-44">
                    <h1 className="text-2xl h-16 mb-2 lg:mb-6 text-wrap font-heading leading-6">Innovation & Excellence</h1>
                ...
                <div className="text-left w-44">
                    <h1 className="text-2xl h-16 mb-2 lg:mb-6 text-wrap font-heading leading-6">Collaborative Impact</h1>
